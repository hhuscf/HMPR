...
class ThreeNN(Function):
    ...
    def forward(ctx, unknown, known):
        ...
        """
        dist2, idx = pointops_cuda.three_nn(unknown, known)
...
class ThreeInterpolate(Function):
    ...
    def forward(ctx, features, idx, weight):
        ...
        return pointops_cuda.three_interpolate(features, idx, weight)
    ...
    def backward(ctx, grad_out):
        ...
        grad_features = pointops_cuda.three_interpolate_grad(
